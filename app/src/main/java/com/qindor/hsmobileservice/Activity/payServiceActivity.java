...
public class payServiceActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void init() {
        dialog1=new LoadingDialog.Builder(payServiceActivity.this)
                .setMessage("加载中...")
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.service_type:
                if(clickUtils.isFastClick()){
                    timer.cancel();
                    i = new Intent(payServiceActivity.this, ServiceTypeActivity.class);
                    startActivity(i);
                    finish();
                }
            ...
            case R.id.service_project:
                if(clickUtils.isFastClick()){
                    if (t4.getText().toString().equals("服务类型")){
                        ...
                        timer.cancel();
                        i = new Intent(payServiceActivity.this, ServiceProjectActivity.class);
    ...
    private void returnedSData(String resultData) {
        try {
            ...
            if (ret.equals("0"))
            {
                ...
                handler.post(toast);
                Intent i = new Intent(payServiceActivity.this, Room_pay_Activity.class);
                Bundle bundle1 = new Bundle();
    ...
    private void back() {
        timer.cancel();
        Intent i = new Intent(payServiceActivity.this, Information_pay_Activity.class);
        Bundle bundle1 = new Bundle();
        bundle1.putSerializable("rooms",roomModel);
        i.putExtras(bundle1);
        startActivity(i);
    ...
    private void scanMethod() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            // 申请权限
            ActivityCompat.requestPermissions(payServiceActivity.this, new String[]{Manifest.permission.CAMERA}, Constant.REQ_PERM_CAMERA);
            return;
        }
        // 二维码扫码
        Intent intent = new Intent(payServiceActivity.this, CaptureActivity.class);
